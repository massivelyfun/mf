...
(function() {
  ...
  MfExecutionContextDetector = (function() {
    ...
    WebExecutionContext = (function(_super) {
      ...
      function WebExecutionContext() {
        return WebExecutionContext.__super__.constructor.apply(this, arguments);
      }
    ...
    NodeExecutionContext = (function(_super) {
      ...
      function NodeExecutionContext() {
        return NodeExecutionContext.__super__.constructor.apply(this, arguments);
      }
  ...
  MfCore = (function() {
    ...
    function MfCore(mf) {
      var _this = this;
      this.once = function(token, fun) {
        return MfCore.prototype.once.apply(_this, arguments);
      };
      this.mf = mf;
      this.klasses = {};
      this.sequencers = {};
  ...
  MfNotificationCenter = (function() {
    ...
    Subject = (function() {
      ...
      Subject.prototype.notify = function(taskManager, action, additionalArgs) {
        ...
        if (this.subscriptions[action] == null) {
          return;
        }
        _ref = this.subscriptions[action];
        _results = [];
